...
<template>
  <div class="bg-slate-100 flex-1 pt-28 pl-7 pr-7 lg:pr-96">
              ...
              <div class="flex flex-row justify-between items-center mt-7">
                <div>
                  ...
                  <code class="font-sans text-xs text-gray-600">
                    <span id="selector-{{this}}">&lt;i class="{{ removePeriods }} {{}}{{this}}"&gt;&lt;/i&gt;</span>
                  </code>
                </div>
                <div>
                  <button

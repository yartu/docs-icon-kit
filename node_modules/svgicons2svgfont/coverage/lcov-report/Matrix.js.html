...
<head>
    <title>Code coverage report for Matrix.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> Matrix.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">2.08% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>6/289</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">1.06% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>1/94</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>5/275</span>
            </div>
...
<a name='L1120'></a><a href='#L1120'>1120</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
function <span class="fstat-no" title="function not covered" >Matrix(</span>context, element) {
  var me = <span class="cstat-no" title="statement not covered" >this,</span>
    _el;
<span class="cstat-no" title="statement not covered" >  me._t = me.transform;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  me.a = me.d = 1;</span>
<span class="cstat-no" title="statement not covered" >  me.b = me.c = me.e = me.f = 0;</span>
&nbsp;
  // sync context
<span class="cstat-no" title="statement not covered" >  if (context) <span class="cstat-no" title="statement not covered" >(me.context = context).setTransform(1, 0, 0, 1, 0, 0);</span></span>
&nbsp;
  // sync DOM element
<span class="cstat-no" title="statement not covered" >  Object.defineProperty(me, 'element', {</span>
    get: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >      return _el;</span>
    },
    set: <span class="fstat-no" title="function not covered" >fu</span>nction (el) {
<span class="cstat-no" title="statement not covered" >      if (!_el) {</span>
<span class="cstat-no" title="statement not covered" >        me._px = me._getPX();</span>
<span class="cstat-no" title="statement not covered" >        me.useCSS3D = false;</span>
      }
<span class="cstat-no" title="statement not covered" >      _el = el;</span>
<span class="cstat-no" title="statement not covered" >      (me._st = _el.style)[me._px] = me.toCSS();</span>
    },
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (element) <span class="cstat-no" title="statement not covered" >me.element = element;</span></span>
}
&nbsp;
/**
 ...
 * @static
 */
Matrix.fromTriangles = <span class="fstat-no" title="function not covered" >fu</span>nction (t1, t2, context) {
  var m1 = <span class="cstat-no" title="statement not covered" >new Matrix(),</span>
    m2 = <span class="cstat-no" title="statement not covered" >new Matrix(context),</span>
    r1,
    r2,
    rx1,
    ry1,
    ...
    ry2;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(t1)) {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof t1[0] === 'number') {</span>
<span class="cstat-no" title="statement not covered" >      rx1 = t1[4];</span>
<span class="cstat-no" title="statement not covered" >      ry1 = t1[5];</span>
<span class="cstat-no" title="statement not covered" >      rx2 = t2[4];</span>
<span class="cstat-no" title="statement not covered" >      ry2 = t2[5];</span>
<span class="cstat-no" title="statement not covered" >      r1 = [t1[0] - rx1, t1[1] - ry1, t1[2] - rx1, t1[3] - ry1, rx1, ry1];</span>
<span class="cstat-no" title="statement not covered" >      r2 = [t2[0] - rx2, t2[1] - ry2, t2[2] - rx2, t2[3] - ry2, rx2, ry2];</span>
    } else {
<span class="cstat-no" title="statement not covered" >      rx1 = t1[2].x;</span>
<span class="cstat-no" title="statement not covered" >      ry1 = t1[2].y;</span>
<span class="cstat-no" title="statement not covered" >      rx2 = t2[2].x;</span>
<span class="cstat-no" title="statement not covered" >      ry2 = t2[2].y;</span>
<span class="cstat-no" title="statement not covered" >      r1 = [</span>
        t1[0].x - rx1,
        t1[0].y - ry1,
        t1[1].x - rx1,
        t1[1].y - ry1,
...
<span class="cstat-no" title="statement not covered" >      r2 = [</span>
        t2[0].x - rx2,
        t2[0].y - ry2,
        t2[1].x - rx2,
        t2[1].y - ry2,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  m1.setTransform.apply(m1, r1);</span>
<span class="cstat-no" title="statement not covered" >  m2.setTransform.apply(m2, r2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return m2.multiply(m1.inverse());</span>
};
&nbsp;
/**
 ...
 */
Matrix.fromSVGTransformList = <span class="fstat-no" title="function not covered" >fu</span>nction (tList, context, dom) {
  var m = <span class="cstat-no" title="statement not covered" >new Matrix(context, dom),</span>
    i = <span class="cstat-no" title="statement not covered" >0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  while (i &lt; tList.length) <span class="cstat-no" title="statement not covered" >m.multiply(tList[i++].matrix);</span></span>
&nbsp;
 ...
 * @static
 */
Matrix.from = <span class="fstat-no" title="function not covered" >fu</span>nction (a, b, c, d, e, f, context, dom) {
  var m = <span class="cstat-no" title="statement not covered" >new Matrix(context, dom),</span>
    scale,
    dist,
    q;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof a === 'number') <span class="cstat-no" title="statement not covered" >m.setTransform(a, b, c, d, e, f);</span></span>
  else <span class="cstat-no" title="statement not covered" >if (typeof a.x === 'number') {</span>
    // vector
&nbsp;
<span class="cstat-no" title="statement not covered" >    q = Math.sqrt(a.x * a.x + a.y * a.y);</span>
<span class="cstat-no" title="statement not covered" >    scale = dist = 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (d) <span class="cstat-no" title="statement not covered" >scale = q;</span></span>
    else <span class="cstat-no" title="statement not covered" >dist = q;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    m.translate(b || 0, c || 0)</span>
      .rotateFromVector(a)
      .scaleU(scale)
      .translate(dist, 0);
  } else {
<span class="cstat-no" title="statement not covered" >    if (typeof a.is2D === 'boolean' &amp;&amp; !a.is2D)</span>
<span class="cstat-no" title="statement not covered" >      throw 'Cannot use 3D DOMMatrix.';</span>
<span class="cstat-no" title="statement not covered" >    if (b) <span class="cstat-no" title="statement not covered" >m.context = b;</span></span>
<span class="cstat-no" title="statement not covered" >    if (c) <span class="cstat-no" title="statement not covered" >m.element = c;</span></span>
<span class="cstat-no" title="statement not covered" >    m.multiply(a);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return m;</span>
};
&nbsp;
Matrix.prototype = {
  _getPX: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var lst = <span class="cstat-no" title="statement not covered" >['t', 'oT', 'msT', 'mozT', 'webkitT', 'khtmlT'],</span>
      i = <span class="cstat-no" title="statement not covered" >0,</span>
      p,
      style = <span class="cstat-no" title="statement not covered" >document.createElement('div').style;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while ((p = lst[i++]))</span>
<span class="cstat-no" title="statement not covered" >      if (typeof style[p + 'ransform'] !== 'undefined') <span class="cstat-no" title="statement not covered" >return p + 'ransform';</span></span>
  },
&nbsp;
  /**
   ...
   */
  concat: <span class="fstat-no" title="function not covered" >fu</span>nction (cm) {
<span class="cstat-no" title="statement not covered" >    return this.clone().multiply(cm);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  flipX: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this._t(-1, 0, 0, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  flipY: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, 0, -1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   */
  reflectVector: <span class="fstat-no" title="function not covered" >fu</span>nction (x, y) {
    var v = <span class="cstat-no" title="statement not covered" >this.applyToPoint(0, 1),</span>
      d = <span class="cstat-no" title="statement not covered" >(v.x * x + v.y * y) * 2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    x -= d * v.x;</span>
<span class="cstat-no" title="statement not covered" >    y -= d * v.y;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return this.setTransform(1, 0, 0, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  rotate: <span class="fstat-no" title="function not covered" >fu</span>nction (angle) {
    var cos = <span class="cstat-no" title="statement not covered" >Math.cos(angle),</span>
      sin = <span class="cstat-no" title="statement not covered" >Math.sin(angle);</span>
<span class="cstat-no" title="statement not covered" >    return this._t(cos, sin, -sin, cos, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  rotateFromVector: <span class="fstat-no" title="function not covered" >fu</span>nction (x, y) {
<span class="cstat-no" title="statement not covered" >    return this.rotate(</span>
...
&nbsp;
   ...
   * @returns {Matrix}
   */
  rotateDeg: <span class="fstat-no" title="function not covered" >fu</span>nction (angle) {
<span class="cstat-no" title="statement not covered" >    return this.rotate((angle * Math.PI) / 180);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  scaleU: <span class="fstat-no" title="function not covered" >fu</span>nction (f) {
<span class="cstat-no" title="statement not covered" >    return this._t(f, 0, 0, f, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  scale: <span class="fstat-no" title="function not covered" >fu</span>nction (sx, sy) {
<span class="cstat-no" title="statement not covered" >    return this._t(sx, 0, 0, sy, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  scaleX: <span class="fstat-no" title="function not covered" >fu</span>nction (sx) {
<span class="cstat-no" title="statement not covered" >    return this._t(sx, 0, 0, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  scaleY: <span class="fstat-no" title="function not covered" >fu</span>nction (sy) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, 0, sy, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  scaleFromVector: <span class="fstat-no" title="function not covered" >fu</span>nction (x, y) {
<span class="cstat-no" title="statement not covered" >    return this.scaleU(Math.sqrt(x * x + y * y));</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  shear: <span class="fstat-no" title="function not covered" >fu</span>nction (sx, sy) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, sy, sx, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  shearX: <span class="fstat-no" title="function not covered" >fu</span>nction (sx) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, sx, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  shearY: <span class="fstat-no" title="function not covered" >fu</span>nction (sy) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, sy, 0, 1, 0, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  skew: <span class="fstat-no" title="function not covered" >fu</span>nction (ax, ay) {
<span class="cstat-no" title="statement not covered" >    return this.shear(Math.tan(ax), Math.tan(ay));</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  skewDeg: <span class="fstat-no" title="function not covered" >fu</span>nction (ax, ay) {
<span class="cstat-no" title="statement not covered" >    return this.shear(</span>
...
&nbsp;
   ...
   * @returns {Matrix}
   */
  skewX: <span class="fstat-no" title="function not covered" >fu</span>nction (ax) {
<span class="cstat-no" title="statement not covered" >    return this.shearX(Math.tan(ax));</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  skewY: <span class="fstat-no" title="function not covered" >fu</span>nction (ay) {
<span class="cstat-no" title="statement not covered" >    return this.shearY(Math.tan(ay));</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  setTransform: <span class="fstat-no" title="function not covered" >fu</span>nction (a, b, c, d, e, f) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    me.a = a;</span>
<span class="cstat-no" title="statement not covered" >    me.b = b;</span>
<span class="cstat-no" title="statement not covered" >    me.c = c;</span>
<span class="cstat-no" title="statement not covered" >    me.d = d;</span>
<span class="cstat-no" title="statement not covered" >    me.e = e;</span>
<span class="cstat-no" title="statement not covered" >    me.f = f;</span>
<span class="cstat-no" title="statement not covered" >    return me._x();</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  translate: <span class="fstat-no" title="function not covered" >fu</span>nction (tx, ty) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, 0, 1, tx, ty);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  translateX: <span class="fstat-no" title="function not covered" >fu</span>nction (tx) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, 0, 1, tx, 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  translateY: <span class="fstat-no" title="function not covered" >fu</span>nction (ty) {
<span class="cstat-no" title="statement not covered" >    return this._t(1, 0, 0, 1, 0, ty);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  transform: <span class="fstat-no" title="function not covered" >fu</span>nction (a2, b2, c2, d2, e2, f2) {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      a1 = <span class="cstat-no" title="statement not covered" >me.a,</span>
      b1 = <span class="cstat-no" title="statement not covered" >me.b,</span>
      c1 = <span class="cstat-no" title="statement not covered" >me.c,</span>
      d1 = <span class="cstat-no" title="statement not covered" >me.d,</span>
      e1 = <span class="cstat-no" title="statement not covered" >me.e,</span>
      f1 = <span class="cstat-no" title="statement not covered" >me.f;</span>
&nbsp;
     ...
     *   0 0 1
     */
<span class="cstat-no" title="statement not covered" >    me.a = a1 * a2 + c1 * b2;</span>
<span class="cstat-no" title="statement not covered" >    me.b = b1 * a2 + d1 * b2;</span>
<span class="cstat-no" title="statement not covered" >    me.c = a1 * c2 + c1 * d2;</span>
<span class="cstat-no" title="statement not covered" >    me.d = b1 * c2 + d1 * d2;</span>
<span class="cstat-no" title="statement not covered" >    me.e = a1 * e2 + c1 * f2 + e1;</span>
<span class="cstat-no" title="statement not covered" >    me.f = b1 * e2 + d1 * f2 + f1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return me._x();</span>
  },
&nbsp;
   ...
   * @returns {Matrix}
   */
  multiply: <span class="fstat-no" title="function not covered" >fu</span>nction (m) {
<span class="cstat-no" title="statement not covered" >    return this._t(m.a, m.b, m.c, m.d, m.e, m.f);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  divide: <span class="fstat-no" title="function not covered" >fu</span>nction (m) {
<span class="cstat-no" title="statement not covered" >    return this.multiply(m.inverse());</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  divideScalar: <span class="fstat-no" title="function not covered" >fu</span>nction (d) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!d) <span class="cstat-no" title="statement not covered" >throw 'Division on zero';</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    me.a /= d;</span>
<span class="cstat-no" title="statement not covered" >    me.b /= d;</span>
<span class="cstat-no" title="statement not covered" >    me.c /= d;</span>
<span class="cstat-no" title="statement not covered" >    me.d /= d;</span>
<span class="cstat-no" title="statement not covered" >    me.e /= d;</span>
<span class="cstat-no" title="statement not covered" >    me.f /= d;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return me._x();</span>
  },
&nbsp;
   ...
   * @returns {Matrix} - new Matrix instance
   */
  inverse: <span class="fstat-no" title="function not covered" >fu</span>nction (cloneContext, cloneDOM) {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      m = <span class="cstat-no" title="statement not covered" >new Matrix(</span>
        cloneContext ? me.context : null,
        cloneDOM ? me.element : null
      ),
      dt = <span class="cstat-no" title="statement not covered" >me.determinant();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!dt) <span class="cstat-no" title="statement not covered" >throw 'Matrix not invertible.';</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    m.a = me.d / dt;</span>
<span class="cstat-no" title="statement not covered" >    m.b = -me.b / dt;</span>
<span class="cstat-no" title="statement not covered" >    m.c = -me.c / dt;</span>
<span class="cstat-no" title="statement not covered" >    m.d = me.a / dt;</span>
<span class="cstat-no" title="statement not covered" >    m.e = (me.c * me.f - me.d * me.e) / dt;</span>
<span class="cstat-no" title="statement not covered" >    m.f = -(me.a * me.f - me.b * me.e) / dt;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return m;</span>
  },
&nbsp;
   ...
   */
  interpolate: <span class="fstat-no" title="function not covered" >fu</span>nction (m2, t, context, dom) {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      m = <span class="cstat-no" title="statement not covered" >new Matrix(context, dom);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    m.a = me.a + (m2.a - me.a) * t;</span>
<span class="cstat-no" title="statement not covered" >    m.b = me.b + (m2.b - me.b) * t;</span>
<span class="cstat-no" title="statement not covered" >    m.c = me.c + (m2.c - me.c) * t;</span>
<span class="cstat-no" title="statement not covered" >    m.d = me.d + (m2.d - me.d) * t;</span>
<span class="cstat-no" title="statement not covered" >    m.e = me.e + (m2.e - me.e) * t;</span>
<span class="cstat-no" title="statement not covered" >    m.f = me.f + (m2.f - me.f) * t;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return m._x();</span>
  },
&nbsp;
  /**
   * Interpolate this matrix with another and produce a new matrix.
   ...
   * @returns {Matrix} - new Matrix instance with the interpolated result
   */
  interpolateAnim: <span class="fstat-no" title="function not covered" >fu</span>nction (m2, t, context, dom) {
    var m = <span class="cstat-no" title="statement not covered" >new Matrix(context, dom),</span>
      d1 = <span class="cstat-no" title="statement not covered" >this.decompose(),</span>
      d2 = <span class="cstat-no" title="statement not covered" >m2.decompose(),</span>
      t1 = <span class="cstat-no" title="statement not covered" >d1.translate,</span>
      t2 = <span class="cstat-no" title="statement not covered" >d2.translate,</span>
      s1 = <span class="cstat-no" title="statement not covered" >d1.scale;</span>
&nbsp;
    // QR order (t-r-s-sk)
<span class="cstat-no" title="statement not covered" >    m.translate(t1.x + (t2.x - t1.x) * t, t1.y + (t2.y - t1.y) * t);</span>
<span class="cstat-no" title="statement not covered" >    m.rotate(d1.rotation + (d2.rotation - d1.rotation) * t);</span>
<span class="cstat-no" title="statement not covered" >    m.scale(s1.x + (d2.scale.x - s1.x) * t, s1.y + (d2.scale.y - s1.y) * t);</span>
...
&nbsp;
   ...
   */
  decompose: <span class="fstat-no" title="function not covered" >fu</span>nction (useLU) {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      a = <span class="cstat-no" title="statement not covered" >me.a,</span>
      b = <span class="cstat-no" title="statement not covered" >me.b,</span>
      c = <span class="cstat-no" title="statement not covered" >me.c,</span>
      d = <span class="cstat-no" title="statement not covered" >me.d,</span>
      acos = <span class="cstat-no" title="statement not covered" >Math.acos,</span>
      atan = <span class="cstat-no" title="statement not covered" >Math.atan,</span>
      sqrt = <span class="cstat-no" title="statement not covered" >Math.sqrt,</span>
      pi = <span class="cstat-no" title="statement not covered" >Math.PI,</span>
      translate = <span class="cstat-no" title="statement not covered" >{ x: me.e, y: me.f },</span>
      rotation = <span class="cstat-no" title="statement not covered" >0,</span>
      scale = <span class="cstat-no" title="statement not covered" >{ x: 1, y: 1 },</span>
      skew = <span class="cstat-no" title="statement not covered" >{ x: 0, y: 0 },</span>
      determ = <span class="cstat-no" title="statement not covered" >a * d - b * c,</span> // determinant(), skip DRY here...
      r,
      s;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (useLU) {</span>
<span class="cstat-no" title="statement not covered" >      if (a) {</span>
<span class="cstat-no" title="statement not covered" >        skew = { x: atan(c / a), y: atan(b / a) };</span>
<span class="cstat-no" title="statement not covered" >        scale = { x: a, y: determ / a };</span>
      } else <span class="cstat-no" title="statement not covered" >if (b) {</span>
<span class="cstat-no" title="statement not covered" >        rotation = pi * 0.5;</span>
<span class="cstat-no" title="statement not covered" >        scale = { x: b, y: determ / b };</span>
<span class="cstat-no" title="statement not covered" >        skew.x = atan(d / b);</span>
      } else {
        // a = b = 0
<span class="cstat-no" title="statement not covered" >        scale = { x: c, y: d };</span>
<span class="cstat-no" title="statement not covered" >        skew.x = pi * 0.25;</span>
      }
    } else {
      // Apply the QR-like decomposition.
<span class="cstat-no" title="statement not covered" >      if (a || b) {</span>
<span class="cstat-no" title="statement not covered" >        r = sqrt(a * a + b * b);</span>
<span class="cstat-no" title="statement not covered" >        rotation = b &gt; 0 ? acos(a / r) : -acos(a / r);</span>
<span class="cstat-no" title="statement not covered" >        scale = { x: r, y: determ / r };</span>
<span class="cstat-no" title="statement not covered" >        skew.x = atan((a * c + b * d) / (r * r));</span>
      } else <span class="cstat-no" title="statement not covered" >if (c || d) {</span>
<span class="cstat-no" title="statement not covered" >        s = sqrt(c * c + d * d);</span>
<span class="cstat-no" title="statement not covered" >        rotation = pi * 0.5 - (d &gt; 0 ? acos(-c / s) : -acos(c / s));</span>
<span class="cstat-no" title="statement not covered" >        scale = { x: determ / s, y: s };</span>
<span class="cstat-no" title="statement not covered" >        skew.y = atan((a * c + b * d) / (s * s));</span>
      } else {
        // a = b = c = d = 0
<span class="cstat-no" title="statement not covered" >        scale = { x: 0, y: 0 };</span>
      }
    }
&nbsp;
...
&nbsp;
   ...
   * @returns {number}
   */
  determinant: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.a * this.d - this.b * this.c;</span>
  },
&nbsp;
  /**
   ...
   */
  applyToPoint: <span class="fstat-no" title="function not covered" >fu</span>nction (x, y) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
...
&nbsp;
   ...
   */
  applyToArray: <span class="fstat-no" title="function not covered" >fu</span>nction (points) {
    var i = <span class="cstat-no" title="statement not covered" >0,</span>
      p,
      l,
      mxPoints = <span class="cstat-no" title="statement not covered" >[];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof points[0] === 'number') {</span>
<span class="cstat-no" title="statement not covered" >      l = points.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      while (i &lt; l) {</span>
<span class="cstat-no" title="statement not covered" >        p = this.applyToPoint(points[i++], points[i++]);</span>
<span class="cstat-no" title="statement not covered" >        mxPoints.push(p.x, p.y);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      while ((p = points[i++])) {</span>
<span class="cstat-no" title="statement not covered" >        mxPoints.push(this.applyToPoint(p.x, p.y));</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return mxPoints;</span>
  },
&nbsp;
  /**
   ...
   */
  applyToTypedArray: <span class="fstat-no" title="function not covered" >fu</span>nction (points, use64) {
    var i = <span class="cstat-no" title="statement not covered" >0,</span>
      p,
      l = <span class="cstat-no" title="statement not covered" >points.length,</span>
      mxPoints = <span class="cstat-no" title="statement not covered" >use64 ? new Float64Array(l) : new Float32Array(l);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (i &lt; l) {</span>
<span class="cstat-no" title="statement not covered" >      p = this.applyToPoint(points[i], points[i + 1]);</span>
<span class="cstat-no" title="statement not covered" >      mxPoints[i++] = p.x;</span>
<span class="cstat-no" title="statement not covered" >      mxPoints[i++] = p.y;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return mxPoints;</span>
  },
&nbsp;
   ...
   * @returns {Matrix}
   */
  applyToContext: <span class="fstat-no" title="function not covered" >fu</span>nction (context) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    context.setTransform(me.a, me.b, me.c, me.d, me.e, me.f);</span>
<span class="cstat-no" title="statement not covered" >    return me;</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  applyToElement: <span class="fstat-no" title="function not covered" >fu</span>nction (element, use3D) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    if (!me._px) <span class="cstat-no" title="statement not covered" >me._px = me._getPX();</span></span>
<span class="cstat-no" title="statement not covered" >    element.style[me._px] = use3D ? me.toCSS3D() : me.toCSS();</span>
<span class="cstat-no" title="statement not covered" >    return me;</span>
  },
&nbsp;
  /**
   ...
   * @returns {Matrix}
   */
  applyToObject: <span class="fstat-no" title="function not covered" >fu</span>nction (obj) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    obj.a = me.a;</span>
<span class="cstat-no" title="statement not covered" >    obj.b = me.b;</span>
<span class="cstat-no" title="statement not covered" >    obj.c = me.c;</span>
<span class="cstat-no" title="statement not covered" >    obj.d = me.d;</span>
<span class="cstat-no" title="statement not covered" >    obj.e = me.e;</span>
<span class="cstat-no" title="statement not covered" >    obj.f = me.f;</span>
<span class="cstat-no" title="statement not covered" >    return me;</span>
  },
&nbsp;
  /**
   ...
   * @returns {boolean}
   */
  isIdentity: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    return me.a === 1 &amp;&amp; !me.b &amp;&amp; !me.c &amp;&amp; me.d === 1 &amp;&amp; !me.e &amp;&amp; !me.f;</span>
  },
&nbsp;
  /**
   ...
   * @returns {boolean}
   */
  isInvertible: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return !this._q(this.determinant(), 0);</span>
  },
&nbsp;
  /**
   ...
   * @returns {boolean}
   */
  isValid: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return !(this.a * this.d);</span>
  },
&nbsp;
  /**
   ...
   * @returns {boolean}
   */
  isEqual: <span class="fstat-no" title="function not covered" >fu</span>nction (m) {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      q = <span class="cstat-no" title="statement not covered" >me._q;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (</span>
      q(me.a, m.a) &amp;&amp;
      q(me.b, m.b) &amp;&amp;
...
&nbsp;
   ...
   */
  clone: <span class="fstat-no" title="function not covered" >fu</span>nction (noContext) {
<span class="cstat-no" title="statement not covered" >    return new Matrix(noContext ? null : this.context).multiply(this);</span>
  },
&nbsp;
  /**
  ...
  toArray: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    return [me.a, me.b, me.c, me.d, me.e, me.f];</span>
  },
&nbsp;
  /**
   ...
   * @returns {*}
   */
  toTypedArray: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    return new Float32Array([me.a, me.b, me.c, me.d, me.e, me.f]);</span>
  },
&nbsp;
  /**
   ...
   * @returns {string}
   */
  toCSS: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return 'matrix(' + this.toArray() + ')';</span>
  },
&nbsp;
  /**
   ...
   * @returns {string}
   */
  toCSS3D: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      n2 = <span class="cstat-no" title="statement not covered" >',0,0,';</span>
<span class="cstat-no" title="statement not covered" >    return (</span>
      'matrix3d(' +
      me.a +
      ',' +
...
&nbsp;
   ...
   * @returns {string}
   */
  toJSON: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    return (</span>
      '{"a":' +
      me.a +
...
&nbsp;
   ...
   * @returns {string}
   */
  toString: <span class="fstat-no" title="function not covered" >fu</span>nction (fixLen) {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >    fixLen = fixLen || 4;</span>
<span class="cstat-no" title="statement not covered" >    return (</span>
      'a=' +
      me.a.toFixed(fixLen) +
      ' b=' +
...
&nbsp;
   ...
   * @returns {string}
   */
  toCSV: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return this.toArray().join() + '\r\n';</span>
  },
&nbsp;
  /**
   ...
   */
  toDOMMatrix: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var m = <span class="cstat-no" title="statement not covered" >null;</span>
<span class="cstat-no" title="statement not covered" >    if ('DOMMatrix' in window) {</span>
<span class="cstat-no" title="statement not covered" >      m = new DOMMatrix();</span>
<span class="cstat-no" title="statement not covered" >      m.a = this.a;</span>
<span class="cstat-no" title="statement not covered" >      m.b = this.b;</span>
<span class="cstat-no" title="statement not covered" >      m.c = this.c;</span>
<span class="cstat-no" title="statement not covered" >      m.d = this.d;</span>
<span class="cstat-no" title="statement not covered" >      m.e = this.e;</span>
<span class="cstat-no" title="statement not covered" >      m.f = this.f;</span>
    }
<span class="cstat-no" title="statement not covered" >    return m;</span>
  },
&nbsp;
   ...
   */
  toSVGMatrix: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this,</span>
      svg = <span class="cstat-no" title="statement not covered" >document.createElementNS('http://www.w3.org/2000/svg', 'svg'),</span>
      svgMatrix = <span class="cstat-no" title="statement not covered" >null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (svg) {</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix = svg.createSVGMatrix();</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.a = me.a;</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.b = me.b;</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.c = me.c;</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.d = me.d;</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.e = me.e;</span>
<span class="cstat-no" title="statement not covered" >      svgMatrix.f = me.f;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return svgMatrix;</span>
  },
&nbsp;
  /**
   ...
   * @private
   */
  _q: <span class="fstat-no" title="function not covered" >fu</span>nction (f1, f2) {
<span class="cstat-no" title="statement not covered" >    return Math.abs(f1 - f2) &lt; 1e-14;</span>
  },
&nbsp;
  /**
   ...
   * @private
   */
  _x: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    var me = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (me.context) <span class="cstat-no" title="statement not covered" >me.context.setTransform(me.a, me.b, me.c, me.d, me.e, me.f);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (me._st) <span class="cstat-no" title="statement not covered" >me._st[me._px] = me.useCSS3D ? me.toCSS3D() : me.toCSS(); </span></span>// can be optimized pre-storing func ref.
&nbsp;
<span class="cstat-no" title="statement not covered" >    return me;</span>
  },
};
&nbsp;
// Node support
<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof exports !== 'undefined') exports.Matrix = Matrix;
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu May 13 2021 21:56:36 GMT+0800 (Singapore Standard Time)
            </div>
        </div>

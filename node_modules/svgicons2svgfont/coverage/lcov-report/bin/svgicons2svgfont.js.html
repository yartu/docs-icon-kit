...
<head>
    <title>Code coverage report for bin/svgicons2svgfont.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">bin</a> svgicons2svgfont.js</h1>
        <div class='clearfix'>
...
program
  ...
  .parse(process.argv);
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (!program.args.length) {
<span class="cstat-no" title="statement not covered" >  console.error('No icons specified!'); </span>// eslint-disable-line
...
new SVGIconsDirStream(files, {
  ...
  log: program.v ? <span class="branch-0 cbranch-no" title="branch not covered" >console.log </span>: <span class="fstat-no" title="function not covered" >fu</span>nction () {}, // eslint-disable-line
})
  .pipe(
    new SVGIcons2SVGFontStream({
      ...
      log: program.v ? <span class="branch-0 cbranch-no" title="branch not covered" >console.log </span>: function () {}, // eslint-disable-line
    })
  )
  .pipe(program.output ? <span class="branch-0 cbranch-no" title="branch not covered" >fs.createWriteStream(program.output) </span>: process.stdout);
&nbsp;</pre></td></tr></table></pre>

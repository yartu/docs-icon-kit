...
<head>
    <title>Code coverage report for src/svgshapes2svgpath.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> svgshapes2svgpath.js</h1>
        <div class='clearfix'>
...
function svgShapesToPathRectToPath(attributes) {
  ...
  const width =
    'undefined' !== typeof attributes.width ? parseFloat(attributes.width) : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
  const height =
...
function svgShapesToPathLineToPath(attributes) {
  ...
  return (
    '' +
    'M' +
    (parseFloat(attributes.x1) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
    ' ' +
    (parseFloat(attributes.y1) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
    ' ' +
    ((parseFloat(attributes.x1) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> + 1).toString(10) +
    ' ' +
    ((parseFloat(attributes.y1) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> + 1).toString(10) +
    ' ' +
    ((parseFloat(attributes.x2) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> + 1).toString(10) +
    ' ' +
    ((parseFloat(attributes.y2) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> + 1).toString(10) +
    ' ' +
    (parseFloat(attributes.x2) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
    ' ' +
    (parseFloat(attributes.y2) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
    'Z'
  );
}
&nbsp;

...
<head>
    <title>Code coverage report for src/iconsdir.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> iconsdir.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable prefer-template,no-confusing-arrow */
'use strict';
&nbsp;
const fs = require('fs');
...
<span class="cstat-no" title="statement not covered" >            this.emit('error', err);</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (metadata.renamed) {
<span class="cstat-no" title="statement not covered" >              this.options.log(</span>
                'Saved codepoint: ' +
                  'u' +
                  metadata.unicode[0]
                    .codePointAt(0)

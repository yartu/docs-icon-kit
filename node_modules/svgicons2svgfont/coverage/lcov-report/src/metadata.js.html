...
<head>
    <title>Code coverage report for src/metadata.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> metadata.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable prefer-template,newline-per-chained-call,complexity */
'use strict';
&nbsp;
...
&nbsp;
    metadata.name =
      matches &amp;&amp; matches[2] ? matches[2] : <span class="branch-1 cbranch-no" title="branch not covered" >'icon' + options.startUnicode;</span>
    if (matches &amp;&amp; matches[1]) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (-1 !== usedUnicodes.indexOf(metadata.unicode[0])) {
